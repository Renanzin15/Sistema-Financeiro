...
def sugerir_categoria(con, user_id, descricao):
    """M2: adivinha a categoria de um gasto livre pela palavra na descrição (uber->transporte...),
    mas SÓ retorna se o usuário tiver uma categoria com esse nome (case-insensitive).
    Retorna o nome real da categoria do usuário, ou None se nada bater."""
